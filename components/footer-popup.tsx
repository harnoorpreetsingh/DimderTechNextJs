...
export function FooterPopup() {
  ...
  return (
    <div className="w-full thisIsClass">
      {/* Trigger button */}
      {/* <button
      ...
      <>
        ...
        <motion.div
          ...
          className="z-50 bg-background/95 backdrop-blur-xl border-t border-border/50 shadow-2xl"
          // className="fixed bottom-0 left-0 right-0  bg-background/95 backdrop-blur-xl border-t border-border/50 max-h-[85vh] overflow-y-auto shadow-2xl"
        >
          <div className="max-w-[90%] mx-auto px-4 py-8">
            {/* Header */}
            <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-4 !w-full">
